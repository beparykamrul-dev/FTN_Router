...
export const STACK_REPOSITORIES: RepoItem[] = [
  ...
  {
    id: 'kismet-wireless',
    name: 'kismetwireless / kismet',
    repo: 'https://github.com/kismetwireless/kismet',
    stars: 6480,
    forks: 1320,
    language: 'C++ / Python',
    category: 'telemetry',
    categoryLabel: 'Monitoring & Telemetry',
    updated: 'Yesterday',
    description: 'Wireless network and device detector, packet sniffer, wardriving tool, and WIDS framework for 802.11 Wi-Fi, Bluetooth, Zigbee, and RTL-SDR.',
    tags: ['Kismet', 'Wireless IDS', '802.11ax', 'RF Sniffer', 'PCAP-NG', 'WIDS'],
    features: ['Live channel hopping (2.4/5/6GHz)', 'Rogue AP & Deauth flood detection', 'KismetDB SQLite structured logging', 'REST API & WebSockets live feed'],
    protocolOrEngine: '802.11 Wi-Fi + BLE + RTL-SDR',
    commandDemo: 'kismet -c wlan0mon:type=linuxwifi,name=alfa0',
    status: 'active'
  },
  {
    id: 'kopia-backup',
    ...
    language: 'Go',
    category: 'storage',
    categoryLabel: 'Storage & Backup Engines',
    updated: '1 day ago',
    description: 'Fast, secure open-source backup tool with end-to-end client-side encryption, content-addressable deduplication, and multi-cloud sync.',
    tags: ['Kopia', 'E2EE Backup', 'Deduplication', 'Snapshots', 'S3/B2', 'ZSTD'],
    features: ['Zero-knowledge AES-256-GCM / ChaCha20', 'Content-defined chunking (Fast deduplication)', 'Automated retention policies (keep-daily/weekly)', 'Multi-cloud repository sync (S3, B2, Azure, SFTP)'],
    protocolOrEngine: 'Kopia Content-Addressable Engine',
    commandDemo: 'kopia snapshot create /etc/ftn --description="Core Router Backup"',
    status: 'active'
  },
  {
    ...
    categoryLabel: 'Monitoring & Telemetry',
    updated: 'Today',
    description: 'Open source distributed search and analytics suite used for log analytics, SIEM security monitoring, real-time application monitoring, and search.',
    tags: ['OpenSearch', 'SIEM', 'Log Analytics', 'Distributed Search', 'Observability', 'ISM'],
    features: ['Lucene & PPL search query language', 'Index State Management (Hot/Warm/Cold rollover)', 'Real-time anomaly detection with ML', 'Syslog, NetFlow & DNS audit trail ingestion'],
    protocolOrEngine: 'OpenSearch Distributed Cluster',
    commandDemo: 'curl -X GET "localhost:9200/_cluster/health?pretty"',
    status: 'active'
  }
];

export const STACK_LISTS = [
  { id: 'all', name: 'All Repositories', count: 56, color: '#00f0ff' },
  { id: 'mystack', name: '🚀 My Stack', count: 56, color: '#00ff66' },
